        ...
        while (attempt < 3 && !match)
        {
            ...
            for (int index = 0; index < count; index++)
            {
                tasks[index] = Task.Run(async () =>
                {
                    ...
                    string text = $"error-{Guid.NewGuid()}-é";
