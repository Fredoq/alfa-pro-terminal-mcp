...
/// <summary>
/// Verifies JsonAssetInfosEntries transformation from router payloads. Usage example: executed by xUnit runner.
/// </summary>
public sealed class JsonAssetInfosEntriesTests
{
    /// <summary>
    /// Ensures that JsonAssetInfosEntries extracts described assets for target identifiers. Usage example: new JsonAssetInfosEntries(payload, ids).Json().
    /// </summary>
    [Fact(DisplayName = "JsonAssetInfosEntries returns described assets for identifiers")]
    ...
    /// <summary>
    /// Checks that JsonAssetInfosEntries yields consistent output in parallel calls. Usage example: entries.Json().
    /// </summary>
    [Fact(DisplayName = "JsonAssetInfosEntries remains consistent under concurrency")]
    public void Given_concurrent_calls_when_parsed_then_outputs_identical()
    {
        ...
        Assert.True(identical, "JsonAssetInfosEntries does not remain consistent under concurrency");
    }

    /// <summary>
    /// Confirms that JsonAssetInfosEntries fails when asset infos are missing. Usage example: entries.Json().
    /// </summary>
    [Fact(DisplayName = "JsonAssetInfosEntries throws when assets are missing")]
